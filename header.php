   ...
   switch($page){
    ...
    case "category.php":
        if(isset($_GET['cid'])){
            ...
            $result_title = mysqli_query($conn,$sql_title) or die("Title QUERY FAILED");
            $row_title = mysqli_fetch_assoc($result_title);
            $page_title = $row_title['category_name']. "Mobile";
          }else{
              $page_title = "NO POST FOUND";   
    ...
    case "author.php":
        if(isset($_GET['aid'])){
            ...
            $result_title = mysqli_query($conn,$sql_title) or die("Title QUERY FAILED");
            $row_title = mysqli_fetch_assoc($result_title);
            $page_title =  "Mobile BY " .$row_title['first_name'] ." " . $row_title['last_name'];
          }else{
              $page_title = "NO POST FOUND";   
    ...
    case "search.php":
        if(isset($_GET['search'])){
            $sql_title ="SELECT * FROM post WHERE post_id = {$_GET['search']} ";
